            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR10.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>SPAMSILOG</h2>
                            <p  class="textDesc">Elevate your breakfast experience with our Spamsilog - a delightful fusion of the classic canned cooked pork, perfectly seasoned sinangag (garlic fried rice), and a sunny-side-up egg. Enjoy the savory and slightly salty notes of spam harmonizing with the aromatic garlic rice, complemented by the richness of a perfectly cooked egg. Savor the simplicity and delectable goodness of Spamsilog - a comforting and satisfying start to your day.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>SPAMSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

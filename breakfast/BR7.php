            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR7.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>LIEMPOSILOG</h2>
                            <p  class="textDesc">A savory ensemble featuring succulent pork belly, perfectly seasoned sinangag (garlic fried rice), and a sunny-side-up egg. Each bite offers a harmonious blend of tender pork, aromatic garlic rice, and the rich creaminess of a perfectly cooked egg. Join us for a breakfast experience that combines classic flavors with a touch of culinary finesse.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>LIEMPOSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

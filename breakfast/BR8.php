            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR8.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>LONGSILOG</h2>
                            <p  class="textDesc">Treat your taste buds to our Longsilog - a delightful harmony of flavorful longganisa, expertly seasoned sinangag (garlic fried rice), and a perfectly cooked sunny-side-up egg. Enjoy the savory goodness of the sausage, the aromatic notes of garlic rice, and the richness of the egg in every mouthful. Experience a breakfast that celebrates the classic Filipino flavors of Longsilog with a touch of culinary excellence.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>LONGSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

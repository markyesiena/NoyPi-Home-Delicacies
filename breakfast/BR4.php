            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR4.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>CORNSILOG</h2>
                            <p  class="textDesc">Enjoy a tasty morning with our Cornsilog - tender corned beef, garlic fried rice, and a sunny-side-up egg. This simple yet satisfying breakfast offers a harmonious blend of savory flavors that will tantalize your taste buds. The melt-in-your-mouth corned beef, paired with the aromatic allure of garlic rice, creates a delectable symphony of tastes in every bite.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>CORNSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR2.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>BANGSILOG</h2>
                            <p  class="textDesc">Our Bangsilog features succulent boneless milkfish, expertly marinated and delicately fried to achieve a perfect crispiness. Nestled alongside is a bed of aromatic sinangag, where each grain of rice is infused with the rich essence of minced garlic, creating a flavorful and slightly crispy foundation.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>BANGSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR1.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>BACSILOG</h2>
                            <p  class="textDesc">Indulge in the ultimate breakfast harmony with our Bacsilog - a symphony of crispy bacon, garlic-infused sinangag (fried rice), and a golden sunny-side-up egg. The smoky notes of bacon dance with the aromatic garlic rice, creating a palate-pleasing sensation. Savor the perfect blend of textures and flavors, making each bite a delicious adventure.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>BACSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

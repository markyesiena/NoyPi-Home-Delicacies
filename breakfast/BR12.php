            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR12.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>TOCILOG</h2>
                            <p  class="textDesc">Tocilog - a meticulously crafted breakfast ensemble that artfully balances the distinct flavors of sweet cured pork, sumptuously seasoned sinangag (garlic fried rice), and a flawlessly cooked sunny-side-up egg. Our tocino, bathed in a marinade that strikes the perfect sweet-savory chord, offers a succulent and tender bite. The garlic fried rice, expertly stirred to golden perfection, exudes an enticing aroma, while the perfectly cooked egg adds a velvety richness to the ensemble.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>TOCILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR11.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>TAPSILOG</h2>
                            <p  class="textDesc">A Filipino breakfast classic that brings together succulent tapa (cured beef), garlic-infused sinangag (fried rice), and a luscious sunny-side-up egg. Our Tapsilog offers a symphony of savory and tender beef, aromatic rice, and the rich goodness of a perfectly cooked egg. Indulge in this flavorful trio, a beloved morning delight that's sure to satisfy your breakfast cravings.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>TAPSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

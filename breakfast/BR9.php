            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR9.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>NUGSILOG</h2>
                            <p  class="textDesc">Embark on a unique breakfast adventure with our Nuggetsilog - a playful twist on the classic Filipino silog experience. Enjoy golden and crispy chicken nuggets paired with fragrant sinangag (garlic fried rice) and a perfectly cooked sunny-side-up egg. Each bite brings together the familiar comfort of nuggets with the savory goodness of garlic rice and the richness of a runny egg yolk.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>NUGSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR6.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>HOTSILOG</h2>
                            <p  class="textDesc">A delightful combination of juicy hotdog, perfectly seasoned sinangag (garlic fried rice), and a sunny-side-up egg. Savor the delicious blend of flavors and textures in each bite, making it the ideal choice for a satisfying and fuss-free morning meal. Start your day with a Hotsilog that's both hearty and delicious.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>HOTSILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

            ...
            <div class="box">
                <center>
                    <div class="content" style="display: flex; justify-content: center; align-items: center;">
                            <img src="/NoyPi-Home-Delicacies/breakfast/BR3.webp" class="toHover" style="border: 3px solid #fff; border-radius: 10px; width: fit-content; margin-right: 20px; max-width: 320px; ">
                        <div>
                            <h2>CHORISILOG</h2>
                            <p  class="textDesc">Kickstart your day with our special Chorisilog, a delightful ensemble of zesty chorizo, garlic-infused sinangag (fried rice), and a sunny-side-up egg. Enjoy the savory fusion of robust chorizo, fragrant garlic rice, and the creamy goodness of a perfectly cooked egg. Relish the delectable harmony of flavors in every bite, making your breakfast a flavorful experience to remember.</p>
                            <table cellspacing="0" style="text-align: center; border: solid 2px;">
                                <tr>
                                    <th colspan="3"><b>CHORISILOG</b></th>
                                </tr>
                                <tr>
                                    <th>Regular Price</th>
                                    <th>Cook Time</th>

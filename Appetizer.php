...
<html>
    ...
    <div class="nav" id="nav">
        ...
        <div class="nav2">
            ...
            <div class="linksNav2">
                <a href="Snacks.html" class="links"><b>Snacks</b></a>
            </div>
            <div class="linksNav2">
                <a href="Dessert.html" class="links"><b>Desserts</b></a>
            </div>
            <div class="linksNav2">
                <a href="/NoyPi-Home-Delicacies/Beverages.html" class="links"><b>Beverages</b></a>
            </div>
            <div class="activeNav">
                <a href="Appetizer.html" class="links"><b>Appetizers</b></a>
            </div>
        </div>
        <br>
        <center>
            <table cellspacing="20px">
                <tr>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B1.html"><img src="/NoyPi-Home-Delicacies/beverages/B1.png" class="productImg1"></a>
                            <div class="desc">Buko Shake</div>
                        </div>
                     
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B2.html"><img src="/NoyPi-Home-Delicacies/beverages/B2.png" class="productImg1"></a>
                            <div class="desc">Sago't Gulaman</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B3.html"><img src="/NoyPi-Home-Delicacies/beverages/B3.png" class="productImg1"></a>
                            <div class="desc">Tsokolate</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B4.html"><img src="/NoyPi-Home-Delicacies/beverages/B4.JPG" class="productImg1"></a>
                            <div class="desc">Kapeng Barako</div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B5.html"><img src="/NoyPi-Home-Delicacies/beverages/B5.jpg" class="productImg1"></a>
                            <div class="desc">Mais con Yelo</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B6.html"><img src="/NoyPi-Home-Delicacies/beverages/B6.heic" class="productImg1"></a>
                            <div class="desc">Halo-halo</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B7.html"><img src="/NoyPi-Home-Delicacies/beverages/B7.jpg" class="productImg1"></a>
                            <div class="desc">Melon Juice</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/beverages/B8.html"><img src="/NoyPi-Home-Delicacies/beverages/B8.jpg" class="productImg1"></a>
                            <div class="desc">Calamansi Juice</div>
                        </div>
                    </td>
                </tr>
            </table>

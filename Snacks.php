        ...
        <center>
            <table cellspacing="20px">
                <tr>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S1.html"><img src="/NoyPi-Home-Delicacies/snacks/S1.jpg" class="productImg1"></a>
                            <div class="desc">Ginataang Monggo</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S2.html"><img src="/NoyPi-Home-Delicacies/snacks/S2.jpg" class="productImg1"></a>
                            <div class="desc">Dynamite</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S3.html"><img src="/NoyPi-Home-Delicacies/snacks/S3.jpg" class="productImg1"></a>
                            <div class="desc">Ginataang Mais</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S4.html"><img src="/NoyPi-Home-Delicacies/snacks/S4.jpg" class="productImg1"></a>
                            <div class="desc">Ensaymada</div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S5.html"><img src="/NoyPi-Home-Delicacies/snacks/S5.jpg" class="productImg1"></a>
                            <div class="desc">Lumpiang Sariwa</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S6.html"><img src="/NoyPi-Home-Delicacies/snacks/S6.jpg" class="productImg1"></a>
                            <div class="desc">Chicken Skin</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S7.html"><img src="/NoyPi-Home-Delicacies/snacks/S7.jpg" class="productImg1"></a>
                            <div class="desc">Mini Pancake</div>
                        </div>
                    </td>
                    <td>
                        <div class="toHover">
                            <a href="/NoyPi-Home-Delicacies/snacks/S8.html"><img src="/NoyPi-Home-Delicacies/snacks/S8.jpg" class="productImg1"></a>
                            <div class="desc">Ginataang Bilo-bilo</div>
                        </div>
                    </td>
                </tr>
            </table>
